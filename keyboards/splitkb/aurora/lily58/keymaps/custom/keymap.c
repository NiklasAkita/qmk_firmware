 ...
 */
 [_QWERTY] = LAYOUT(
  ...
  KC_LSFT,  KC_Z,   KC_X,    KC_C,    KC_V,    KC_B, KC_LBRC,  KC_RBRC,  KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH,  KC_RSFT,
                        KC_LALT, LT(8, KC_ESC), LT(6, KC_TAB), LT( 5, KC_SPC) , LT( 10,KC_ENT), LT(9, KC_BSPC), LT(11,KC_DEL ), KC_RGUI
),
 ...
 */
 ...
 [_COLEMAK_DH] = LAYOUT(
  ...
  KC_LCTL,  KC_A , LALT_T(KC_R), CTL_T(KC_S), SFT_T(KC_T), KC_G,         KC_M,    RSFT_T(KC_N),    RCTL_T(KC_E),   RALT_T(KC_I),    KC_O, KC_QUOT,
 ...
 */
  ...
  _______, _______, KC_LALT, KC_LCTL, KC_LSFT,   _______,                    KC_CAPS, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, _______,
